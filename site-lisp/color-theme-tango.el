...
;;; Minor changes by dgutov@yandex.ru
...
(defun color-theme-tango ()
  ...
  (color-theme-install
   '(color-theme-tango
     ...
     (font-lock-builtin-face ((t (:foreground "#8ae234" :bold t))))
     (font-lock-comment-face ((t (:foreground "#6d7e8a" :italic t))))
     (font-lock-constant-face ((t (:foreground "#ad7fa8"))))
     (font-lock-doc-face ((t (:foreground "#8ae234"))))
